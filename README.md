...
These models correspond to the final checkpoints for each training configuration used in the experiments — spanning controlled real data, synthetic domain-randomized data, and synthetic + controlled fine-tuning. | **Model** | **Training Regime** | **Description** | **Download** |
|------------|---------------------|-----------------|---------------|
| **YOLOv8s** | Pretrained YOLOv8s | Baseline pretrained on COCO dataset | [Download](https://huggingface.co/NeFr25/TTA-Sim2Real-YOLO-Models/resolve/main/weights/yolov8s.pt) |
| **YOLOv9s** | Pretrained YOLOv9s | Baseline pretrained on COCO dataset | [Download](https://huggingface.co/NeFr25/TTA-Sim2Real-YOLO-Models/resolve/main/weights/yolov9s.pt) |
| **YOLO-Worldv2** | Pretrained YOLO-Worldv2 | Baseline pretrained on Objects365 dataset and others | [Download](https://huggingface.co/NeFr25/TTA-Sim2Real-YOLO-Models/resolve/main/weights/yolov8m-worldv2.pt) |
